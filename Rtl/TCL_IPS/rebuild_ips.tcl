puts "Rebuilding IPs..."
set current_sript_dir  [file normalize [file dirname [info script]]]
puts "current_sript_dir: $current_sript_dir"

puts "Creating AD_CLK_PLL"
source [file join $current_sript_dir/ip_tcl/AD_CLK_PLL.tcl]

puts "Creating cmpy_16X16"
source [file join $current_sript_dir/ip_tcl/cmpy_16X16.tcl]

puts "Creating complexMult_IPCore"
source [file join $current_sript_dir/ip_tcl/complexMult_IPCore.tcl]

puts "Creating DDS_16X16"
source [file join $current_sript_dir/ip_tcl/DDS_16X16.tcl]

puts "Creating DIV_ATT"
source [file join $current_sript_dir/ip_tcl/DIV_ATT.tcl]

puts "Creating div_calfreq"
source [file join $current_sript_dir/ip_tcl/div_calfreq.tcl]

puts "Creating div_idendFreq"
source [file join $current_sript_dir/ip_tcl/div_idendFreq.tcl]

puts "Creating FIFO_Data_Sync"
source [file join $current_sript_dir/ip_tcl/FIFO_Data_Sync.tcl]

puts "Creating g_clock_mmcm"
source [file join $current_sript_dir/ip_tcl/g_clock_mmcm.tcl]

puts "Creating ila_128Xbit"
source [file join $current_sript_dir/ip_tcl/ila_128Xbit.tcl]

puts "Creating ila_64Xbit"
source [file join $current_sript_dir/ip_tcl/ila_64Xbit.tcl]

puts "Creating Rx_ReSample_FIR_F2"
source [file join $current_sript_dir/ip_tcl/Rx_ReSample_FIR_F2.tcl]

puts "Creating Rx_ReSample_FIR_F4_L1"
source [file join $current_sript_dir/ip_tcl/Rx_ReSample_FIR_F4_L1.tcl]

puts "Creating Rx_ReSample_FIR_F4_L2"
source [file join $current_sript_dir/ip_tcl/Rx_ReSample_FIR_F4_L2.tcl]

puts "Creating Rx_ReSample_FIR_F5"
source [file join $current_sript_dir/ip_tcl/Rx_ReSample_FIR_F5.tcl]

puts "Creating Tx_ReSample_FIR_F2"
source [file join $current_sript_dir/ip_tcl/Tx_ReSample_FIR_F2.tcl]

puts "Creating Tx_ReSample_FIR_F4_L1"
source [file join $current_sript_dir/ip_tcl/Tx_ReSample_FIR_F4_L1.tcl]

puts "Creating Tx_ReSample_FIR_F4_L2"
source [file join $current_sript_dir/ip_tcl/Tx_ReSample_FIR_F4_L2.tcl]

puts "Creating Tx_ReSample_FIR_F5"
source [file join $current_sript_dir/ip_tcl/Tx_ReSample_FIR_F5.tcl]

puts "Creating vio_0"
source [file join $current_sript_dir/ip_tcl/vio_0.tcl]

puts "Creating xfft_IPCore"
source [file join $current_sript_dir/ip_tcl/xfft_IPCore.tcl]
